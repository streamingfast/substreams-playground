...
func main() {
	registry.Register("pcs_pair_extractor", func(imp *imports.Imports) reflect.Value { return reflect.ValueOf(&pcs.PairExtractor{Imports: imp}) })
	...
	registry.Register("pcs_derived_prices_state_builder", func(imp *imports.Imports) reflect.Value { return reflect.ValueOf(&pcs.DerivedPricesStateBuilder{}) })
	...
	registry.Register("pcs_volumes_state_builder", func(imp *imports.Imports) reflect.Value { return reflect.ValueOf(&pcs.PCSVolume24hStateBuilder{}) })
